...
- in mac open rider and do a dotnet run command
- in windows open up in Visul studio and run it
- in case of any errors make sure the CORS in Program.cs is matched with your localHost
